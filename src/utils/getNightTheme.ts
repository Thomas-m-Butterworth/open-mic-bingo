...
export const nightMap: NightMapType = {
  ...
  swamp: {
    ...
    colours: {
      bg: "var(--swamp-green)",
      text: "var(--swamp-black)",
      bingoText: "var(--swamp-black)",
      headerText: "var(--swamp-orange)",
      headerStroke: "var(--swamp-white)",
      bingoSelect: "var(--swamp-orange)",
      bingoBg: "var(--swamp-white)",
      buttonBg: "var(--swamp-orange)",
      buttonStroke: "var(--swamp-red)",
    },
    styles: {
      titleBtm: "0px",
      titleLeft: "0px",
